...
This version of Melius will downgrade your game to version 1.15.222, which is the version before the Free Lanes update. I will release a version based on the latest version in due course but first I need to wait for a few mods to be updated that are essential for this list.
...
* You need the latest Steam version (1.16.244) of the game and the Shattered Space DLC.
