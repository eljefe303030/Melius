...
6. Frame rates can drop drastically whilst in the console command prompt. The cause of this has been established, waiting for the mod authors to release a fix.
7. Crosshairs for some weapons are unavailable and will need a patch to bring them back.
