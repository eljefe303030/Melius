...
6. Frane rates can drop drastically whilst in the console command prompt. The cause of this has been established, waiting for the mod authors to release a fix.
