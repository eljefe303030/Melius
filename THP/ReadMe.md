...
|[CHRONOMARK FieldOS - Dynamic HUD Skin Pack for HONKCORE](https://www.nexusmods.com/starfield/mods/17491)|SFSE mod that let's you have up to 24 Favorite Items.|Does not always work well with controllers.|Yes|
|[Favorites Menu Extended - SFSE](https://www.nexusmods.com/starfield/mods/14314)|A tactical HUD skin set for HONKCORE - Dynamic Custom HUD.|Includes patch by Ashkenas that adjusts this to include changes, such as HUD visible in 3rd person and the scanner for enemies works only on scanner mode while on combat.|Yes|
