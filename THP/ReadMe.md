...
8. [Extremophile - Environmental Gameplay](https://www.nexusmods.com/starfield/mods/15601) A minimalist rework of Environmental Damage and Hazard gameplay in Starfield.
9. [Peak Performance - Minimalist Needs](https://www.nexusmods.com/starfield/mods/12420) This mod replaces the Sustenance system with a lightweight needs mod with high depth and intuitive features. **Hint: the Grav Nova 1x1 Workshop hab has a shower, so no requirements for sani-wipes on your spaceship :-). You need to sleep once before this mod enables.**
...
18. [Stellar Crafting - Quality Crafting Overhaul](https://www.nexusmods.com/starfield/mods/16665) Upgrades no longer run on credits alone. Go out, find resources, and earn your gear the proper way through exploration, looting, mining, and crafting instead of simply paying for it.
...
29. [Better Spaceship Interaction Distance](https://www.nexusmods.com/starfield/mods/12641) Changes docking and looting distance to 55. Increases distance you can access the cargo on the ground to 2000.
...
|[1stHelmetVisor](https://www.nexusmods.com/starfield/mods/17595)|A piece of equipment that adds a visor effect in first person.|Significant FPS hit; only use if you have them to spare. Enable by equiping the visor in your inventory.|Yes|
...
|Mod|Description|Comments|Safe to enable/disable mid save|
|---|---|---|---|
|[Crew Eats Food](https://www.nexusmods.com/starfield/mods/12100)|Ship crew periodically consume food and drink items from your cargo hold. You get a small XP buff for keeping them fed and a small penalty if they go hungry.||Safe to enable mid save but avoid removing from an existing save.|
...
[Kelishnikov has produced a spreadsheet](https://docs.google.com/spreadsheets/d/1EvLcoelOD5FgGUJ0LSCl_1gCDqwwPbHB/edit?usp=drivesdk&ouid=102026282995791747753&rtpof=true&sd=true) that shows the pointer handle figures with no Optionals, No Extra Creations, just SKK fast start at the beginning of a new game in THP version 1.4. If you suddenly start getting crashes and you have added additional mods, check your pointer handle figures. You can get the figures via [Starfield Engine Fixes](https://www.nexusmods.com/starfield/mods/10457) and it's believed you need around 400k to 500k spare to ensure a stable game.
...
* [Grounded Enemies](https://www.nexusmods.com/starfield/mods/16957) A combined overhaul that makes combat faster and the world more believable — trimmed health pools, smarter aggression, and natural size variety across all enemies. **Enable this optional mod to reduce the difficulty of the game**
...
* [Not Yet Shattered Space](https://www.nexusmods.com/starfield/mods/14112) and [Not Yet Terran Armada](https://www.nexusmods.com/starfield/mods/17143) Delays the DLCs starting until a configurable point in the main quest, see main game settings.
...
Before updating the modlist, check the [changelog](https://github.com/eljefe303030/Melius/blob/main/THP/Changelog.md) and it is advisable to back up your saves first. It will state in the changelog if you need to start a new game after certain updates.
