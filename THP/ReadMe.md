...
> [!IMPORTANT]
> In the Vectera mine at the beginning of the game, there is a cutter with a level 2 attachment laying on the ground next to the cutter crate you would normally grab a cutter from. You **HAVE** to pick up the one in the cutter crate first. **THEN** you can **hold, not single press** the equip button on the cutter on the floor to use that instead. If you do this out of order you can accidentally lock yourself out of tutorial progression.
