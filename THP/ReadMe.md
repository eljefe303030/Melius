...
|[CharGenMenu](https://www.nexusmods.com/starfield/mods/6850)|Modifies the vanilla CharGenMenu to show numbers, compacts vertical space to show more sliders, adds JSON presets, and more.|**Can cause crashes at the character creation screen. Recommended to enable just before visiting Enhanced, save game before enabling.** Not requireed unless you want to use presets.|Yes|
