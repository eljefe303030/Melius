...
|[Smart Aiming - Third to First Person - SFSE - Plugin](https://www.nexusmods.com/starfield/mods/11706)|Automatically switch to first person when aiming your weapon, and back to third person upon release.|**Disable Scopes Without Overlays if using this. OR use the optional configuaration ini, which will switch to 1st person on weapon draw.** Ini provided to change settings, see mod page for more details.|Yes|
