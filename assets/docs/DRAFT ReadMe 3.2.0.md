...
8. [Peak Performance - Minimalist Needs](https://www.nexusmods.com/starfield/mods/12420) This mod replaces the Sustenance system with a lightweight needs mod with high depth and intuitive features. **hint, the Grav Nova 1x1 Workshop hab has a shower, no no requirements for sani-wipes on your spaceship**
...
**72 TOOLS**
[Starfield Shader Cache Reset] Starfield Shader Cache Reset Tool – safely clears all known shader caches, including pipeline.cache. Use if you have stutters, black textures, and other graphical issues. **[see this section for instructions](#strange-visual-effects)
